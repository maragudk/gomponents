...
func Form(action, method string, children ...g.Node) g.NodeFunc {
	return g.El("form", g.Attr("action", action), g.Attr("method", method), g.Wrap(children...))
}
...
func Input(typ, name string, children ...g.Node) g.NodeFunc {
	return g.El("input", g.Attr("type", typ), g.Attr("name", name), g.Wrap(children...))
}
...
func Label(forr string, children ...g.Node) g.NodeFunc {
	return g.El("label", g.Attr("for", forr), g.Wrap(children...))
}
...
func Option(text, value string, children ...g.Node) g.NodeFunc {
	return g.El("option", g.Attr("value", value), g.Text(text), g.Wrap(children...))
}
...
func Select(name string, children ...g.Node) g.NodeFunc {
	return g.El("select", g.Attr("name", name), g.Wrap(children...))
}
...
func Textarea(name string, children ...g.Node) g.NodeFunc {
	return g.El("textarea", g.Attr("name", name), g.Wrap(children...))
}
