...
func TestMap(t *testing.T) {
	t.Run("transforms integers to strings with index", func(t *testing.T) {
		input := []int{1, 2, 3}
	...
	t.Run("transforms strings to their lengths plus index", func(t *testing.T) {
	...
	t.Run("transforms structs to other structs", func(t *testing.T) {
		type Person struct {
			Name string
			Age  int
		}
...
func TestFilter(t *testing.T) {
	...
	t.Run("filters structs by field value", func(t *testing.T) {
		type Product struct {
			Name  string
			Price float64
		}
...
func TestCombinedOperations(t *testing.T) {
	...
	t.Run("map filter reduce pipeline calculates total widget revenue", func(t *testing.T) {
		type Sale struct {
			Product  string
			Quantity int
			Price    float64
