...
func Bdi(children ...g.Node) g.Node {
	return g.El("bdi", children...)
}

func Bdo(children ...g.Node) g.Node {
	return g.El("bdo", children...)
}
...
func FencedFrame(children ...g.Node) g.Node {
	return g.El("fencedframe", children...)
}
...
func MapEl(children ...g.Node) g.Node {
